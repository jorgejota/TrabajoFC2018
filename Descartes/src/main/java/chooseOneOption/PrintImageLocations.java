	...
	protected void processOperator( Operator operator, List<COSBase> operands) throws IOException
	{
		...
		if( "Do".equals(operation) )
		{
			...
			if( xobject instanceof PDImageXObject)
			{
				...
				System.out.println();
				File fileee = new File("C:\\Users\\jorge\\Desktop\\Images2\\" + objectName.getName() + ".png");
	            ImageIO.write(((org.apache.pdfbox.pdmodel.graphics.image.PDImageXObject)xobject).getImage(), "png", fileee);
			}
